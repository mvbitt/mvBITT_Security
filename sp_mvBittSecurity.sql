/******************************************
sp_mvBittSecurity Marcus Vinícius Bittencourt
...
EXECUTE sp_mvBittSecurity
GO
************************************************************************/

-- Drop stored procedure if it already exists
DROP PROCEDURE if exists sp_mvBittSecurity
GO

IF EXISTS (
  SELECT * 
    FROM INFORMATION_SCHEMA.ROUTINES 
   WHERE SPECIFIC_NAME = sp_mvBittSecurity
   AND SPECIFIC_CATALOG = 'dbmanutencao'
)
   DROP PROCEDURE sp_mvBittSecurity
GO

CREATE PROCEDURE sp_mvBittSecurity
AS
   -- =============================================
